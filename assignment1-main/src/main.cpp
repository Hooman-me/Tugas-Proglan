...
int yearsOld(tm* inputTgl, tm* currentTgl)
{
    int Tahun = currentTgl->tm_year - inputTgl->tm_year;
...
int monthsOld(tm* inputTgl, tm* currentTgl)
{
    int Bulan = (currentTgl->tm_year - inputTgl->tm_year) * 12;
    Bulan += (currentTgl->tm_mon - inputTgl->tm_mon);
...
string dayOfDate(tm* inputTgl)
{
    ...
    mktime(inputTgl);
    return daftarHari[inputTgl->tm_wday];
}
//*********************************************************************************************************************
//*********************************************************************************************************************
